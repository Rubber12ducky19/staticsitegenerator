...
class Test_Extract_Image(unittest.TestCase):
    def test_01(self):
        print("Extract:\n Images-\n -Test 1")
    ...
    def test_02(self):
        print("-Test 2")
        matches = extract_markdown_images("This is a ![rick roll](https://i.imgur.com/aKaOqIh.gif) and ![obi wan](https://i.imgur.com/fJRm4Vk.jpeg)")
